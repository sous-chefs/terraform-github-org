...
resource "github_membership" "Martin_Smith" {
  username = "martinb3"
  role     = "member"
}
...
resource "github_membership" "Grant_Ridder" {
...
resource "github_membership" "sbotman" {
  username = "sbotman"
  role     = "member"
}

resource "github_membership" "shoekstra" {
  username = "shoekstra"
  role     = "member"
}

resource "github_membership" "teknofire" {
  username = "teknofire"
  role     = "member"
}

resource "github_membership" "Elias_Abacioglu" {
  username = "Raboo"
  role     = "member"
}
...
resource "github_membership" "snkutlu" {
  username = "snkutlu"
  role     = "member"
}
...
resource "github_membership" "MarkGibbons" {
  username = "MarkGibbons"
  role     = "member"
}

resource "github_membership" "gsreynolds" {
  username = "gsreynolds"
  role     = "member"
}
...
resource "github_membership" "sinfomicien" {
...
resource "github_membership" "Stromweld" {
  username = "Stromweld"
  role     = "member"
}

resource "github_membership" "brianbianco" {
  username = "brianbianco"
  role     = "member"
}

resource "github_membership" "aried3r" {
  username = "aried3r"
  role     = "member"
}
...
resource "github_membership" "fernandoaleman" {
...
resource "github_membership" "duncaan" {
  username = "duncaan"
  role     = "member"
}

resource "github_membership" "AsherYanich" {
  username = "ayanich"
  role     = "member"
}

resource "github_membership" "zmaupin" {
  username = "zmaupin"
  role     = "member"
}

resource "github_membership" "ryantiger658" {
...
resource "github_membership" "ITJamie" {
  username = "ITJamie"
  role     = "member"
}
...
resource "github_membership" "darwin67" {
  username = "darwin67"
  role     = "member"
}
...
resource "github_membership" "marcosvm" {
  username = "marcosvm"
  role     = "member"
}
...
resource "github_membership" "mbaitelman" {
  username = "mbaitelman"
  role     = "member"
}

resource "github_membership" "mburns" {
  username = "mburns"
  role     = "member"
}

resource "github_membership" "detjensrobert" {
  username = "detjensrobert"
  role     = "member"
}

resource "github_membership" "zimmerry" {
  username = "zimmerry"
  role     = "member"
}

resource "github_membership" "Tomoya_Kabe" {
  username = "limitusus"
  role     = "member"
}

resource "github_membership" "Ethan_Hampton" {
  username = "EMH333"
  role     = "member"
}

resource "github_membership" "nuclearsandwich" {
  username = "nuclearsandwich"
  role     = "member"
}

resource "github_membership" "jakauppila" {
  username = "jakauppila"
  role     = "member"
}

resource "github_membership" "frank-m" {
  username = "frank-m"
  role     = "member"
}
